 ...
 * @author RFaiz
 */
public class AddStudentinRegister extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form AddStudentinRegister
     */
    private volatile static AddStudentinRegister uniqueInstance = null;
    private volatile static JFrame uniqueJframe = null;

    public AddStudentinRegister() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
        ResultSet rs = null;
    ...
    public static AddStudentinRegister getInstance() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (AddStudentinRegister.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new AddStudentinRegister();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (AddStudentinRegister.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Add Customer");
                }
            }
        }
        uniqueJframe.setLocationRelativeTo(null);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == back) {
            ...
            try {
                ...
                Logger.getLogger(AddStudentinRegister.class.getName()).log(Level.SEVERE, null, ex);
            }
