 ...
 * @author RFaiz
 */
public class EditStudent extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form EditStudent
     */
    private volatile static EditStudent uniqueInstance = null;
    ...
    public static EditStudent getInstance() throws ClassNotFoundException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (EditStudent.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new EditStudent();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (EditStudent.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Edit Student");
                }
            }
        }
