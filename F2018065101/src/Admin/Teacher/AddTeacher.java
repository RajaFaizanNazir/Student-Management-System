 ...
 * @author RFaiz
 */
public class AddTeacher extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form AddTeacher
     */
    private volatile static AddTeacher uniqueInstance = null;
    private volatile static JFrame uniqueJframe = null;

    public AddTeacher() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        initComponents();
        ResultSet rs = null;
        rs = Query.executeQuery("SELECT MAX(id) as id FROM Teacher; ");
        int idint = 0;
        if (rs != null) {
            while (rs.next()) {
    ...
    public static AddTeacher getInstance() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (AddTeacher.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new AddTeacher();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (AddTeacher.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Add Teacher");
                }
            }
        }
        uniqueJframe.setLocationRelativeTo(null);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == back) {
            ...
            try {
                String statement = ("INSERT INTO teacher(name,email,maxcr) VALUES(\'" + name.getText() + "\',\'"
                        + email.getText() + "\'," + cr.getValue().toString() + ");");
