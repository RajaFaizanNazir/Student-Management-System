 ...
 * @author RFaiz
 */
public class DeleteTeacher extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form DeleteTeacher
     */
    private volatile static DeleteTeacher uniqueInstance = null;
    ...
    public static DeleteTeacher getInstance() throws ClassNotFoundException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (DeleteTeacher.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new DeleteTeacher();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (DeleteTeacher.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Delete Teacher");
                }
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == back) {
            ...
            try {
                if (Query.executeUpdate("delete from teacher where id=" + option + ";") > 0) {
                    JFrame f = new JFrame();
