 ...
 * @author RFaiz
 */
public class EditTeacher extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form EditTeacher
     */
    private volatile static EditTeacher uniqueInstance = null;
    ...
    public static EditTeacher getInstance() throws ClassNotFoundException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (EditTeacher.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new EditTeacher();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (EditTeacher.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Edit Teacher");
                }
            }
        }
