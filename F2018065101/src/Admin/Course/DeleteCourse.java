 ...
 * @author RFaiz
 */
public class DeleteCourse extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form DeleteCourse
     */
    private volatile static DeleteCourse uniqueInstance = null;
    ...
    public static DeleteCourse getInstance() throws ClassNotFoundException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (DeleteCourse.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new DeleteCourse();
                }
            }
        }
        ...
        if (uniqueJframe == null) { //Single Checked
            synchronized (DeleteCourse.class) {
                if (uniqueJframe == null) { //Double Checked
                    ...
                    uniqueJframe.setTitle("Delete Course");
                }
            }
        }
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == back) {
            ...
            try {
                if (Query.executeUpdate("delete from course where id=" + option + ";") > 0) {
                    JFrame f = new JFrame();
