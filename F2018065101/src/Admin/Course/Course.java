 ...
 * @author RFaiz
 */
public class Course extends javax.swing.JPanel implements ActionListener {

    /**
     * Creates new form Course
     */
    private volatile static Course uniqueInstance = null;
    ...
    public static Course getInstance() throws ClassNotFoundException {
        if (uniqueInstance == null) { //Single Checked
            synchronized (Course.class) {
                if (uniqueInstance == null) { //Double Checked
                    uniqueInstance = new Course();
                }
            }
        }
